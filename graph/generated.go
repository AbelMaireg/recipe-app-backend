...
func (ec *executionContext) field_Mutation_signIn_argsInput(
	...
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNSignInInput2goᚑgraphqlᚑappᚋgraphᚋmodelᚐSignInInput(ctx, tmp)
	}
...
func (ec *executionContext) field_Mutation_signUp_argsInput(
	...
	ctx = graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNSignUpInput2goᚑgraphqlᚑappᚋgraphᚋmodelᚐSignUpInput(ctx, tmp)
	}
...
func (ec *executionContext) _Mutation_signUp(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNUser2ᚖgoᚑgraphqlᚑappᚋgraphᚋmodelᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_signIn(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNSignInResponse2ᚖgoᚑgraphqlᚑappᚋgraphᚋmodelᚐSignInResponse(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalNSignInInput2goᚑgraphqlᚑappᚋgraphᚋmodelᚐSignInInput(ctx context.Context, v any) (model.SignInInput, error) {
	res, err := ec.unmarshalInputSignInInput(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNSignInResponse2goᚑgraphqlᚑappᚋgraphᚋmodelᚐSignInResponse(ctx context.Context, sel ast.SelectionSet, v model.SignInResponse) graphql.Marshaler {
	return ec._SignInResponse(ctx, sel, &v)
}

func (ec *executionContext) marshalNSignInResponse2ᚖgoᚑgraphqlᚑappᚋgraphᚋmodelᚐSignInResponse(ctx context.Context, sel ast.SelectionSet, v *model.SignInResponse) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNSignUpInput2goᚑgraphqlᚑappᚋgraphᚋmodelᚐSignUpInput(ctx context.Context, v any) (model.SignUpInput, error) {
...
func (ec *executionContext) marshalNUser2goᚑgraphqlᚑappᚋgraphᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v model.User) graphql.Marshaler {
	return ec._User(ctx, sel, &v)
}

func (ec *executionContext) marshalNUser2ᚖgoᚑgraphqlᚑappᚋgraphᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v *model.User) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
